...
echo 구버전 작업 제거 (NosimSalesCollectToday / NosimSalesCollectFinalize, 있을 때만)...
powershell -ExecutionPolicy Bypass -Command "Unregister-ScheduledTask -TaskName 'NosimSalesCollectToday' -Confirm:$false -ErrorAction SilentlyContinue"
powershell -ExecutionPolicy Bypass -Command "Unregister-ScheduledTask -TaskName 'NosimSalesCollectFinalize' -Confirm:$false -ErrorAction SilentlyContinue"
